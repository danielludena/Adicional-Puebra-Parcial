...
public class IngresoVehiculo extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LogPropietario objLogPropietario = new LogPropietario();
        ...
        objVehiculo.setPlaca(this.jTextField4.getText());
        objVehiculo.setMarca(this.jTextField5.getText());
        objVehiculo.setEstado(this.jTextField6.getText());
        
       
        
            try {
                objLogPropietario.Insertar1(objPropietario);
            ...
            try {
                objLogPropietario.Insertar2(objVehiculo);
            } catch (ClassNotFoundException ex) {
                throw new RuntimeException(ex);
            } catch (SQLException ex) {
                throw new RuntimeException(ex);
